    ...
    def delete(self, id: UUID) -> None:
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail="Grupo está vinculado a matérias-primas e não pode ser excluído. Inative-o.",
            )
        logger.info("Material group deleted: id=%s code=%s", existing.id, existing.code)
