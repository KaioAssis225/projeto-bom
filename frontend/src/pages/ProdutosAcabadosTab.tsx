...
import { AlertCircle, Loader2, Plus, RefreshCcw, RefreshCw, Search, Upload, X } from "lucide-react";
...
export default function ProdutosAcabadosTab() {
  ...
  const handleRefreshCosts = async () => {
    ...
    try {
      ...
      toast.success("Custos dos PAs atualizados");
    } finally {
      setRefreshing(false);
    }
  };
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              title="Recalcula o custo BOM de todos os PAs (limpa o cache local)"
            >
              {refreshing ? (
